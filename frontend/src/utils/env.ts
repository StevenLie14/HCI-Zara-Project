type ProjectEnvVariableType = Pick<
  ImportMetaEnv,
  | "VITE_MINIO_URL"
  | "VITE_BACKEND_URL"
...
export const getProjectEnvVariables = (): ProjectEnvVariableType => {
  return {
    VITE_MINIO_URL: !projectEnvVariables.VITE_MINIO_URL.includes("VITE_")
      ? projectEnvVariables.VITE_MINIO_URL
      : import.meta.env.VITE_MINIO_URL,
    VITE_ENVIRONMENT_NAME: !projectEnvVariables.VITE_ENVIRONMENT_NAME.includes(
      "VITE_",
    )
      ? projectEnvVariables.VITE_ENVIRONMENT_NAME
      : import.meta.env.VITE_ENVIRONMENT_NAME,
    VITE_GENERATE_SOURCEMAP:
      !projectEnvVariables.VITE_GENERATE_SOURCEMAP.includes("VITE_")
        ? projectEnvVariables.VITE_GENERATE_SOURCEMAP
        : import.meta.env.VITE_GENERATE_SOURCEMAP,
    VITE_APPLICATION_NAME: !projectEnvVariables.VITE_APPLICATION_NAME.includes(
      "VITE_",
    )
      ? projectEnvVariables.VITE_APPLICATION_NAME
      : import.meta.env.VITE_APPLICATION_NAME,
    VITE_APPLICATION_VERSION:
      !projectEnvVariables.VITE_APPLICATION_VERSION.includes("VITE_")
