type ProjectEnvVariableType = Pick<ImportMetaEnv, "VITE_MINIO_URL" | "VITE_BACKEND_URL" | "VITE_ENVIRONMENT_NAME" | "VITE_APPLICATION_NAME" | "VITE_APPLICATION_VERSION" | "VITE_GENERATE_SOURCEMAP">
...
export const getProjectEnvVariables = (): ProjectEnvVariableType => {
  return {
    VITE_MINIO_URL: !projectEnvVariables.VITE_MINIO_URL.includes("VITE_") ? projectEnvVariables.VITE_MINIO_URL : import.meta.env.VITE_MINIO_URL,
