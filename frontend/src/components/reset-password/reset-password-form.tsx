...
import {
  ...
  resetPasswordSchema,
} from "@/models/dto/request/auth/reset-password-request.ts";
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <FormControl>
                <div className="space-y-1">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button
                      disabled={
                        otpMutation.isPending || resetPasswordMutation.isPending
                      }
                      type="button"
                      variant="outline"
                      onClick={sendOtp}
        ...
        />
        <Button
          disabled={resetPasswordMutation.isPending || otpMutation.isPending}
          type="submit"
          className="w-full"
        >
