        ...
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            ...
            <button
              type="button"
              onClick={() =>
                appendImage({ productImage: "", imageFile: undefined })
              }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {imageFields.map((field, index) => (
              ...
              >
                <input
                  type="hidden"
                  {...register(`images.${index}.productImage` as const)}
                />
                ...
                {errors.images?.[index]?.productImage && (
                  <p className="mt-1 text-sm text-red-600">
                    {errors.images[index]?.productImage?.message}
                  </p>
                )}
              </div>
            ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  {errors.variants?.[index]?.variantImage && (
                    <p className="mt-1 text-sm text-red-600">
                      {errors.variants[index]?.variantImage?.message}
                    </p>
                  )}
                  <input
                    type="hidden"
                    {...register(`variants.${index}.variantImage` as const)}
                  />
